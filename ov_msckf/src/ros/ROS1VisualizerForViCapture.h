...
#ifndef OV_MSCKF_ROS1VisualizerForViCapture_H
#define OV_MSCKF_ROS1VisualizerForViCapture_H
 ...
 */
class ROS1VisualizerForViCapture : public ROS1Visualizer {
...
#endif // OV_MSCKF_ROS1VisualizerForViCapture_H
