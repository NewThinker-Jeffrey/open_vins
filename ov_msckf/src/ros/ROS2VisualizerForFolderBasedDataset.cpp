...
ROS2VisualizerForFolderBasedDataset::ROS2VisualizerForFolderBasedDataset(std::shared_ptr<rclcpp::Node> node, std::shared_ptr<VioManager> app, std::shared_ptr<Simulator> sim)
...
void ROS2VisualizerForFolderBasedDataset::setup_subscribers(std::shared_ptr<ov_core::YamlParser> parser) {
...
void ROS2VisualizerForFolderBasedDataset::visualize() {
...
void ROS2VisualizerForFolderBasedDataset::visualize_odometry(double timestamp) {
...
void ROS2VisualizerForFolderBasedDataset::visualize_final() {
...
void ROS2VisualizerForFolderBasedDataset::callback_inertial(const ov_core::ImuData& message) {
  ...
  //     for (const auto &cam_msg : this->camera_queue) {
  ...
  //       while (!this->camera_queue.empty() && this->camera_queue.at(0).timestamp < timestamp_imu_inC) {
  //         camera_queue.push_back(std::move(this->camera_queue.front()));
  //         this->camera_queue.pop_front();
  //       }
  //     }
  //   }
...
void ROS2VisualizerForFolderBasedDataset::publish_state() {
...
void ROS2VisualizerForFolderBasedDataset::publish_images() {
...
void ROS2VisualizerForFolderBasedDataset::publish_features() {
...
void ROS2VisualizerForFolderBasedDataset::publish_groundtruth() {
...
void ROS2VisualizerForFolderBasedDataset::publish_loopclosure_information() {
