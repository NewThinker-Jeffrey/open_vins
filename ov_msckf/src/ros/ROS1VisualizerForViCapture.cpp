...
#include "ROS1VisualizerForViCapture.h"
...
ROS1VisualizerForViCapture::ROS1VisualizerForViCapture(
  ...
  ROS1Visualizer(nh, getVioManagerFromVioInterface(app.get()), nullptr, gl_viewer, output_dir, save_feature_images, save_total_state),
  sys_(app) {
