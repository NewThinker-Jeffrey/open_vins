...
bool DynamicInitializer::initialize(double &timestamp, Eigen::MatrixXd &covariance, std::vector<std::shared_ptr<ov_type::Type>> &order,
  ...
  std::vector<ov_core::ImuData> readings = ov_core::select_imu_readings(*imu_data, time0_in_imu, time1_in_imu);
  ...
  for (auto const &timepair : map_camera_times) {
    ...
    std::vector<ov_core::ImuData> cpiI0toIi1_readings =
        ov_core::select_imu_readings(*imu_data, cpiI0toIi1_time0_in_imu, cpiI0toIi1_time1_in_imu);
    ...
    std::vector<ov_core::ImuData> cpiIitoIi1_readings =
        ov_core::select_imu_readings(*imu_data, cpiIitoIi1_time0_in_imu, cpiIitoIi1_time1_in_imu);
